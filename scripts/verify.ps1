...
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-claimcheck-detail.ps1

php tests/test_domain_review.php

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-claimcheck-properties.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-claimcheck-golden.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-claimcheck-casebook.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
