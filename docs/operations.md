...
`claimcheck` is centered on security tooling work in PHP. The technical target is: Validate OIDC-style claim, nonce, and redirect policy fixtures.
...
The score is deterministic. The current threshold is 151. Risk has a penalty of 5, latency has a penalty of 4, and weight contributes a bonus of 5.
