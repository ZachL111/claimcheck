...
claimcheck is a PHP project for security tooling. It focuses on this technical goal: Validate OIDC-style claim, nonce, and redirect policy fixtures.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 151, risk penalty 5, latency penalty 4, and weight bonus 5. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
