"""Regression checks for the claimcheck casebook."""
...
from casebook.harness import assert_expected, claimcheck_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(claimcheck_summary(), assert_expected())
